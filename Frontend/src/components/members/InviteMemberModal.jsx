        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              className="w-full bg-slate-950 text-white border border-slate-800 focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 rounded-xl py-3 px-4 text-sm outline-none transition-all cursor-pointer"
            >
            ...
            {errors.role && (
              <span className="text-xs text-red-400">{errors.role.message}</span>
            )}
          </div>
