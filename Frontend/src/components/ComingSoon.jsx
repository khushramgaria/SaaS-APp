...
const ComingSoon = ({ title, description, icon: Icon }) => {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen">
      <div className="relative mb-6">
        <div className="absolute -inset-4 bg-gradient-to-r from-violet-600 to-indigo-600 rounded-full blur-xl opacity-20 dark:opacity-30 animate-pulse"></div>
        <div className="relative w-20 h-20 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center text-violet-600 dark:text-violet-400 shadow-xl">
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="px-5 py-2.5 rounded-xl bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-800 font-medium text-sm transition-all cursor-pointer">
          Explore Workspace
        </button>
      </div>
    </div>
